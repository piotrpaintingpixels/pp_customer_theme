...
if ( ! function_exists( 'cornerstone_entry_meta_init' ) ) :
	function cornerstone_entry_meta_init() {
		...
		$entry_meta_header_args = get_theme_mod( 'entry_meta_header', array() );
		$entry_meta_header_order = array();
		foreach( $entry_meta_header_args as $entry_meta_header ) :
			$entry_meta_header_order[] = $entry_meta_header['entry_meta'];
		endforeach;
		$entry_meta_args_top = array( 'order' => $entry_meta_header_order );

		//$entry_meta_args_bottom = array('order' => array('categories', 'tags'));
		//$entry_meta_footer_order = array('order' => array());
		$entry_meta_footer_args = get_theme_mod( 'entry_meta_footer', array() );
		$entry_meta_footer_order = array();
		foreach( $entry_meta_footer_args as $entry_meta_footer ) :
			$entry_meta_footer_order[] = $entry_meta_footer['entry_meta'];
		endforeach;
		$entry_meta_args_bottom = array( 'order' => $entry_meta_footer_order );
