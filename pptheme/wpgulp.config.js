...
module.exports = {
	...
	// Project options.
	projectURL: 'ppsystem.local', // Local project URL of your already running WordPress site. Could be something like wpgulp.local or localhost:3000 depending upon your local WordPress setup.
	...
	bugReport: 'https://paintingpixels.co.uk', // Where can users report bugs.
	lastTranslator: 'Painting Pixels <developer@paintingpixels.co.uk>', // Last translator Email ID.
	team: 'Painting Pixels <developer@paintingpixels.co.uk', // Team's Email ID.
