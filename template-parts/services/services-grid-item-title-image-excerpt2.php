...
<div class="cell">
	<div id="post-<?php the_ID(); ?>" <?php post_class( array( 'card', 'service-wrapper', 'service-style-title-image-excerpt2' ), null ); ?> style="<?php echo $card_background; ?>" data-equalizer-watch="services">
